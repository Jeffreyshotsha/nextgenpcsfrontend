  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      fetchedOrders.forEach((order) => {
        const totalDuration = order.delivery === "delivery" ? 600 : 120;
...
const DeliveryMap = ({ countdown }) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", backgroundColor: "#d3d3d3", position: "relative", borderRadius: "12px" }}>
      ...
      <div style={{ position: "absolute", left: "5%", top: "50%", transform: "translate(-50%, -130%)", fontSize: "30px", zIndex: 6 }}>Store</div>
      <div style={{ position: "absolute", left: "95%", top: "50%", transform: "translate(-50%, -130%)", fontSize: "30px", zIndex: 6 }}>Pin</div>
    </div>
  );
};
...
const PickupMap = ({ orderId }) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%", backgroundColor: "#d3d3d3", borderRadius: "12px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", left: "20%", top: "0%", transform: "translate(-50%, -130%)", fontSize: "30px", zIndex: 9 }}>Pin</div>
      <div style={{ position: "absolute", left: "95%", top: "35%", transform: "translate(-50%, -130%)", fontSize: "36px", color: "#ffcc00", textShadow: "0 0 8px #ffcc00", zIndex: 10 }}>Store</div>
    </div>
  );
};
